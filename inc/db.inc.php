...
class ASysDB {
    ...
    */
    ...
    /**
    * Выполняем sql запрос и возвращаем резкльтат в виде одного значения
    */
    ...
    */
    ...
    /**
    * Выполняем sql запрос и возвращаем таблицу записей
    */
